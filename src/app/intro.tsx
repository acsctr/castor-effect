...
export default function Intro() {
    ...
    return (
        <div id="intro">
            ...
            <Game />
            <p className="text-xs leading-snug" id="gametext7" hidden>BONNE RÉPONSE ! Considéré comme nuisible, chassé pour sa fourrure, pour ses glandes odorantes... Il ne restait que sept castors en France dans les années 1930, selon le comptage de l&apos;Office national de la chasse et de la faune sauvage (ONCFS). Il était pourtant le premier mammifère à faire l&apos;objet d&apos;une protection dès 1909.</p>
            <p className="text-xs leading-snug" id="gametext27" hidden>EH NON ! Considéré comme nuisible, chassé pour sa fourrure, pour ses glandes odorantes... Il ne restait que sept castors en France dans les années 1930, selon le comptage de l&apos;Office national de la chasse et de la faune sauvage (ONCFS). Il était pourtant le premier mammifère à faire l&apos;objet d&apos;une protection dès 1909.</p>
            <strong>Une espèce parapluie</strong>
